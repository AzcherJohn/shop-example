...
export default function ProductCard(props){
   const {image, name, description, id} = props.details;
   ...
   return <>
      <Link to={"/products/" + id}>
         <div className={`${appCont.isDarkTheme ? "bg-zinc-500" : "bg-zinc-300"} rounded flex gap-5 p-3 justify-between items-center`}>
